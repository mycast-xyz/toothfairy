		...
		>
			<thead class="bg-gray-50 dark:bg-gray-800">
				<tr>
					<th
						scope="col"
						class="cursor-pointer px-2 py-1.5 text-left text-[10px] font-normal text-gray-500 dark:text-gray-400 rtl:text-right"
						>날짜</th
					>
					<th
						scope="col"
			...
			<tbody>
				{#each dateInfo as item}
					...
					<tr class="border-b border-gray-200 {rowClass}">
						<td class="whitespace-nowrap border-r px-2 py-1 text-[10px] font-medium">{item.date}</td
						>
						<td class="whitespace-nowrap border-r px-2 py-1 text-[10px] font-medium"
						...
						>
						<td
							class="cursor-pointer border-r px-2 py-1.5 text-left font-normal text-gray-500 dark:text-gray-400 rtl:text-right"
						>
							{#if item.stlListData?.directory}
								<p
									class=" max-w-[500px] whitespace-normal break-words text-[10px] font-normal text-gray-500 dark:text-gray-400"
								>
